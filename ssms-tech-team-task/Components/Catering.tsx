...
const Catering = () => {
    return (
        ...
        <div className='md:w-1/2 md:px-10 lg:pt-10 lg:pb-5 lg:px-20'>
        ...
        <div className=' bg-white py-7 md:w-1/2'>
          ...
          <div className={paris.className}>
            <h1 className='text-center py-2 text-xl md:text-2xl text-buttonbgblue'>Let us cater your next event</h1>
          </div>
          <p className=' text-center px-10 md:text-lg md:px-20'>
